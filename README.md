...
| `black_title(std::string)` | Sets the title black must have | | `[BlackTitle "..."]` |
...
| `result(std::string)` | Sets the outcome the game must have | | `[Result "..."]` |
...
| `white_title(std::string)` | Sets the title that white must have | | `[WhiteTitle "..."]` |
